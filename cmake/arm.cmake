...
# TODO: @mbed-os-tools we need to get preprocessor options in here to be able to preprocess
# startup files - they need -D symbols and probably also common symbols
set(CMAKE_ASM_FLAGS
    "--cpu=Cortex-M4 --cpreproc --cpreproc_opts=--target=arm-arm-none-eabi,-D,__FPU_PRESENT"
)
set(CMAKE_CXX_LINK_FLAGS
    "-Wl,--cpu=Cortex-M4,--verbose,--remove,--show_full_path,--legacyalign,--any_contingency,--keep=os_cb_sections -mcpu=cortex-m4 -mthumb -mfpu=none -DMBED_ROM_START=0x0 -DMBED_ROM_SIZE=0x100000 -DMBED_RAM1_START=0x1fff0000 -DMBED_RAM1_SIZE=0x10000 -DMBED_RAM_START=0x20000000 -DMBED_RAM_SIZE=0x30000 -DMBED_BOOT_STACK_SIZE=1024 -DXIP_ENABLE=0"
)
